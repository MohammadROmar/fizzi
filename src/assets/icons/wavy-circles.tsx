...
export default function WavyCircles(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        className="wavy-circles-outer origin-center -scale-x-100 animate-spin [animation-duration:22s]"
        fill="currentColor"
      ...
      />
      <path
        className="wavy-circles-inner origin-center animate-spin [animation-duration:16s]"
        fill="currentColor"
